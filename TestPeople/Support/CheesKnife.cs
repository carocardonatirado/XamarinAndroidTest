...
namespace Com.Lilarcor.Cheeseknife {
  ...
  public class BaseInjectionAttribute : Attribute {
    ...
    public BaseInjectionAttribute(int resourceId, bool optional = false) {
  ...
  public class InjectView : BaseInjectionAttribute {  
    public InjectView(int resourceId, bool optional = false) : base(resourceId, optional) { }
  }
  ...
  public class InjectOnClick : BaseInjectionAttribute {
    public InjectOnClick(int resourceId, bool optional = false) : base(resourceId, optional) { }
  }
  ...
  public class InjectOnCheckedChange : BaseInjectionAttribute {
    public InjectOnCheckedChange(int resourceId, bool optional = false) : base(resourceId, optional) { }
  }
  ...
  public class InjectOnEditorAction : BaseInjectionAttribute {
    public InjectOnEditorAction(int resourceId, bool optional = false) : base(resourceId, optional) { }
  }
  ...
  public class InjectOnFocusChange : BaseInjectionAttribute {
    public InjectOnFocusChange(int resourceId, bool optional = false) : base(resourceId, optional) { }
  }
  ...
  public class InjectOnItemClick : BaseInjectionAttribute {
    public InjectOnItemClick(int resourceId, bool optional = false) : base(resourceId, optional) { }
  }
  ...
  public class InjectOnItemLongClick : BaseInjectionAttribute {
    public InjectOnItemLongClick(int resourceId, bool optional = false) : base(resourceId, optional) { }
  }
  ...
  public class InjectOnLongClick : BaseInjectionAttribute {
    public InjectOnLongClick(int resourceId, bool optional = false) : base(resourceId, optional) { }
  }
  ...
  public class InjectOnTouch : BaseInjectionAttribute {
    public InjectOnTouch(int resourceId, bool optional = false) : base(resourceId, optional) { }
  }
  ...
  public class InjectOnTextChanged : BaseInjectionAttribute {
    public InjectOnTextChanged(int resourceId, bool optional = false) : base(resourceId, optional) { }
  }
  ...
  public class InjectOnAfterTextChanged : BaseInjectionAttribute {
    public InjectOnAfterTextChanged(int resourceId, bool optional = false) : base(resourceId, optional) { }
  }
  ...
  public static class Cheeseknife {
    ...
    static void InjectMethod(Type attributeType, MethodInfo method, object parent, View view, string eventName) {
      ...
      if (attribute.Optional && widget == null) {
        return;
      }
